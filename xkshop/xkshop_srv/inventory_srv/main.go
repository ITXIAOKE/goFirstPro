...
import (
	...
	"os/signal"
	"syscall"
	"xkshop/v1/xkshop_srv/inventory_srv/handler"
	"xkshop/v1/xkshop_srv/inventory_srv/utils/register/consul"

	"xkshop/v1/xkshop_srv/inventory_srv/global"
	"xkshop/v1/xkshop_srv/inventory_srv/initialize"
	"xkshop/v1/xkshop_srv/inventory_srv/proto"
	"xkshop/v1/xkshop_srv/inventory_srv/utils"
)
